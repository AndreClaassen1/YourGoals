...
class TodayScheduleCalculatorTests: StorageTestCase {
    ...
    func testCalulateStartingTimesWithoutActiveTask() {
        ...
        XCTAssertEqual(StartingTimeInfo(hour: 13, minute: 00, second: 00, remainingMinutes: 30.0, conflicting: false, fixed: false), times[0])
        XCTAssertEqual(StartingTimeInfo(hour: 13, minute: 30, second: 00, remainingMinutes: 90.0, conflicting: false, fixed: false), times[1])
    }
    ...
    func testCalulateStartingTimesWithActiveTask() {
        ...
        XCTAssertEqual(StartingTimeInfo(hour: 12, minute: 45, second: 00, end: Date.timeWith(hour: 13, minute: 15, second: 00),
                                        remainingMinutes: 15.0, conflicting: false, fixed: false), times[0])
        XCTAssertEqual(StartingTimeInfo(hour: 13, minute: 15, second: 00, remainingMinutes: 90.0, conflicting: false, fixed: false), times[1])
    }
    ...
    func testCalulateStartingTimesWithFixedBeginTime() {
        ...
        XCTAssertEqual(2, times.count)
        XCTAssertEqual(StartingTimeInfo(hour: 13, minute: 00, second: 00, remainingMinutes: 30.0, conflicting: false, fixed: false), times[0])
        XCTAssertEqual(StartingTimeInfo(hour: 14, minute: 00, second: 00, remainingMinutes: 90.0, conflicting: false, fixed: true), times[1])
    }
    ...
    func testCalulateStartingTimesWithFixedBeginTimeInDanger() {
        ...
        // test
        XCTAssertEqual(2, times.count)
        XCTAssertEqual(StartingTimeInfo(hour: 13, minute: 00, second: 00, remainingMinutes: 90.0, conflicting: false, fixed: false), times[0])
        XCTAssertEqual(StartingTimeInfo(hour: 14, minute: 00, second: 00, remainingMinutes: 90.0, conflicting: true, fixed: true), times[1])
    }
}
